...
import { ADD_SELLER, ALL_SELLER, DELETE_SELLER, EDIT_SELLER } from "../../network/Api";
...
export const getAllSeller =(refresh = false, page=1) => async (dispatch, getState) => {
    // console.log({adminData})
    const { sellers } = getState().sellerReducer;
