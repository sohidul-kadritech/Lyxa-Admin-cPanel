        ...
        <React.Fragment>
            <GlobalWrapper>
                ...
                <Row>
                    ...
                    <Col xl={3} md={6}>
                        <DashboardCard title='Delivery Boy' value={summery?.totalDeliveryBoy} icon={user3} />
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    {/* <Col xl={3} md={6}>
                <DashboardCard title='Riders Unsettled Amount' value={`${summery?.deliveryBoyUnsettleAmount} NGN`} icon={servicesIcon4} />
              </Col>
