...
import { SellerMenuItem } from "../../assets/SideMenuItem";

const SellerSidebarContent = (props) => {
  const ref = useRef();
...
SellerSidebarContent.propTypes = {
  location: PropTypes.object,
  t: PropTypes.any,
};

export default withRouter(withTranslation()(SellerSidebarContent));
