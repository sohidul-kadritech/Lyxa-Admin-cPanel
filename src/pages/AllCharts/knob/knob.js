...
class Knob extends React.Component {
  ...
  getArcToValue = (v) => {
    ...
    const angle = !this.props.log
      ...
      : Math.log((v / this.props.min) ** this.angleArc) / Math.log(this.props.max / this.props.min);
  ...
  coerceToStep = (v) => {
    let val = !this.props.log
      ...
      : this.props.step ** ~~((Math.abs(v) < 1 ? -0.5 : 0.5) + Math.log(v) / Math.log(this.props.step));
  ...
  eventToValue = (e) => {
    ...
    const val = !this.props.log
      ...
      : (this.props.max / this.props.min) ** (a / this.angleArc) * this.props.min;
  ...
  handleWheel = (e) => {
    ...
    if (e.deltaX > 0 || e.deltaY > 0) {
      this.props.onChange(
        this.coerceToStep(!this.props.log ? this.props.value + this.props.step : this.props.value * this.props.step)
      );
