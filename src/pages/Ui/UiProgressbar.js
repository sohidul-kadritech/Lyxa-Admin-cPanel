          ...
          <Col lg={6}>
            <Card>
              <CardBody>
                ...
                <div className="">
                  <div className="mb-2">
                    <Progress className="progress-sm" value={25} color="primary" style={{ height: '5px' }} />
                  </div>
                  <div>
                    <Progress className="mb-2" value={25} color="primary" style={{ height: '20px', width: '100%' }} />
                  </div>
                </div>
              </CardBody>
            </Card>
            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  ...
                  <code className="highlighter-rouge"> striped animated </code> to to animate the stripes right to left
                  via CSS3 animations.
                </p>
          ...
          <Col lg={6}>
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Add <code className="highlighter-rouge"> striped </code> to any to apply a stripe via CSS gradient
