              ...
              <CardBody>
                <Row>
                  <Col lg={6}>
                    ...
                    <div>
                      <Badge className="bg-primary">Primary</Badge> <Badge className="bg-success">Success</Badge>{' '}
                      <Badge className="bg-info">Info</Badge> <Badge className="bg-warning">Warning</Badge>{' '}
                      <Badge className="bg-danger">Danger</Badge> <Badge className="bg-dark">Dark</Badge>{' '}
                    </div>
                  </Col>
                  <Col lg={6}>
                    ...
                    <p className="card-title-desc">
                      Use the
                      <code>.rounded-pill</code> modifier className to make badges more rounded (with a larger{' '}
                      <code>border-radius</code>
                      and additional horizontal <code>padding</code>). Useful if you miss the badges from v3.
                    </p>

                    <div>
                      <Badge className="rounded-pill bg-primary">Primary</Badge>{' '}
                      <Badge className="rounded-pill bg-success">Success</Badge>{' '}
                      <Badge className="rounded-pill bg-info">Info</Badge>{' '}
                      <Badge className="rounded-pill bg-warning">Warning</Badge>{' '}
              ...
              <CardBody>
                ...
                <Row>
                  <Col lg={6}>
                    ...
                    <p className="card-title-desc">
                      Fancy larger or smaller pagination? Add <code>.pagination-lg</code>
                      or <code>.pagination-sm</code> for additional sizes.
                    </p>
