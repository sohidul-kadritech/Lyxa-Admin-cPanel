            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    You can use a link with the <code className="highlighter-rouge">href</code> attribute, or a button
                    with the <code className="highlighter-rouge">data-target</code> attribute. In both cases, the{' '}
              ...
              <Card>
                <CardBody>
                  ...
                  <p>
                    ...
                    each reference it with their <code>href</code> or <code>data-bs-target</code> attribute
                  </p>

                  <div className="d-flex gap-2 flex-wrap mb-3">
                    <Link to="#" onClick={this.t_col6} style={{ cursor: 'pointer' }} className="btn btn-primary">
