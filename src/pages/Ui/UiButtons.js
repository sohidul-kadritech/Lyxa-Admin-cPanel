            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Reactstarp includes six predefined button styles, each serving its own semantic purpose.
                </p>
                <div className="button-items">
                  <Button color="primary" className="btn btn-primary waves-effect waves-light">
                    Primary
                  </Button>{' '}
                  <Button color="secondary" className="btn btn-secondary waves-effect">
                    Secondary
                  </Button>{' '}
                  ...
                  <Button color="warning" className="btn btn-warning waves-effect waves-light">
                    Warning
                  </Button>{' '}
                  <Button color="danger" className="btn btn-danger waves-effect waves-light">
                    Danger
                  </Button>{' '}
                  <Button color="dark" className="btn btn-dark waves-effect waves-light">
                    Dark
                  </Button>{' '}
            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  ...
                  <code className="highlighter-rouge">.btn-outline-* </code> ones to remove all background images and
                ...
                <div className="button-items">
                  ...
                  <Button color="dark" outline className="waves-effect waves-light">
                    Dark
                  </Button>{' '}
            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc ">
                  ...
                  classes are designed to be used with the <code className="highlighter-rouge">
                    &lt;button&gt;
                  </code>{' '}
                  element. However, you can also use these classes on{' '}
                  <code className="highlighter-rouge">&lt;a&gt;</code> or{' '}
                  <code className="highlighter-rouge">&lt;input&gt;</code> elements (though some browsers may apply a
                ...
                <div className="button-items">
                  ...
                  <Button color="success" className="btn btn-success waves-effect waves-light" type="submit">
                    Button
                  </Button>{' '}
            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  ...
                  <code className="highlighter-rouge">.btn-sm</code> for additional sizes.
                </p>

                <div className="button-items">
                  <Button color="primary" className="btn btn-primary btn-lg waves-effect waves-light">
                    Large button
                  </Button>{' '}
                  <Button color="secondary" className="btn btn-secondary btn-lg waves-effect">
                    Large button
                  </Button>{' '}
                  <Button color="primary" className="btn btn-primary btn-sm waves-effect waves-light">
                    Small button
                  </Button>{' '}
                  <Button color="secondary" className="btn btn-secondary btn-sm waves-effect">
                    Small button
                  </Button>
                </div>
              </CardBody>
              ...
              <CardBody>
                ...
                <div className="button-items">
                  <div className="d-grid">
                    <Button color="primary" className="btn btn-primary btn-lg w-100 waves-effect waves-light">
                      Block level button
                    </Button>{' '}
                    <Button color="secondary" className="btn btn-secondary btn-sm w-100 waves-effect mt-2">
                      Block level button
                    </Button>
                  </div>
                </div>
          ...
          <Col lg={6}>
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Bootstrap’s <code className="highlighter-rouge">.button</code> styles can be applied to other
                  elements, such as <code className="highlighter-rouge">&lt;label&gt;</code>s, to provide checkbox or
                  radio style button toggling. Add <code className="highlighter-rouge">data-toggle="buttons"</code> to a
                  <code className="highlighter-rouge">.btn-group</code> containing those modified buttons to enable
                  toggling in their respective styles.
                </p>
            ...
            <Card>
              <CardBody>
                ...
                <div className="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                  ...
                  <label className="btn btn-primary active" htmlFor="btncheck4">
                    Active
                  </label>
            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  ...
                  <code className="highlighter-rouge">.btn-group</code>, including each one when nesting multiple
                  groups.
                </p>
            ...
            <Card>
              <CardBody>
                ...
                <div className="btn-group-vertical" role="group" aria-label="Vertical button group">
                  ...
                  <Button color="secondary" type="button" className="btn btn-secondary">
                    Button
                  </Button>
                  <Button color="secondary" type="button" className="btn btn-secondary">
                    Button
