...
import { Alert, Card, CardBody, CardTitle, Col, Container, Row, UncontrolledAlert } from 'reactstrap';
            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  ...
                  styling, use one of the four <strong>required</strong> contextual classes (e.g.,{' '}
                  <code className="highlighter-rouge">.alert-success</code>). For inline dismissal, use the alerts
                  jQuery plugin.{' '}
                </p>
          ...
          <Col lg={6}>
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Use the <code className="highlighter-rouge">.alert-link</code> utility className to quickly provide
          ...
          <Col lg={6}>
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Alerts are available for any length of text, as well as an optional dismiss button. For proper
                  styling, use one of the fourr <strong>required</strong> contextual classes (e.g.,{' '}
                  <code className="highlighter-rouge">.alert-success .bg-**</code>
