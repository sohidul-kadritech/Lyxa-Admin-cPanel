          ...
          <Col lg={6}>
            <Card>
              <CardBody>
                ...
                <h3>
                  ...
                  <small className="text-muted fw-normal font-size-18">Semibold 1.53125rem (24.5px)</small>
                </h3>
                <h4>
                ...
                <h5>
                  ...
                  <small className="text-muted fw-normal font-size-18">Semibold 1.09375rem (17.5px)</small>
                </h5>
                <h6 className="mb-0">
            ...
            <Card>
              <CardBody>
                ...
                <p>
                  Quickly change the <code>font-size</code> of text. While our heading classes (e.g.,
            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Remove a list’s bullets and apply some light <code className="highlighter-rouge">margin</code> with a
                  combination of two className, <code className="highlighter-rouge">.list-inline</code> and
          ...
          <Col lg={6}>
            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Remove the default <code className="highlighter-rouge">list-style</code> and left margin on list items
                  (immediate children only). <strong>This only applies to immediate children list items</strong>,
                  meaning you will need to add the className for any nested lists as well.
                </p>
          ...
          <Col className="col-12">
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Align terms and descriptions horizontally by using our grid system’s predefined className (or semantic
                  mixins). For longer terms, you can optionally add a{' '}
                  <code className="highlighter-rouge">.text-truncate</code> className to truncate the text with an
                  ellipsis.
                </p>
