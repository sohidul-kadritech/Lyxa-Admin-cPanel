            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Any single <code className="highlighter-rouge">.btn</code> can be turned into a dropdown toggle with
                ...
                <Row>
                  ...
                  <Col sm={6}>
                    <Dropdown isOpen={singlebtn1} toggle={() => setSinglebtn1(!singlebtn1)} className="mt-4 mt-sm-0">
                      <DropdownToggle className="btn btn-secondary" caret>
            ...
            <Card>
              <CardBody>
                ...
                <div className="d-flex gap-2 flex-wrap">
                  ...
                  <div className="btn-group">
                    <Dropdown isOpen={btnInfo1} toggle={() => setBtnInfo1(!btnInfo1)}>
                  ...
                  <div className="btn-group">
                    <Dropdown isOpen={btnWarning1} toggle={() => setBtnWarning1(!btnWarning1)}>
                  ...
                  <div className="btn-group">
                    <Dropdown isOpen={btnDanger1} toggle={() => setBtnDanger1(!btnDanger1)}>
            ...
            <Card>
              <CardBody>
                ...
                <div className="d-flex gap-2 flex-wrap">
                  ...
                  <div className="btn-group">
                    <ButtonDropdown isOpen={drp_secondary1} toggle={() => setDrp_secondary1(!drp_secondary1)}>
                  ...
                  <div className="btn-group">
                    <ButtonDropdown isOpen={drp_success1} toggle={() => setDrp_success1(!drp_success1)}>
                  ...
                  <div className="btn-group">
                    <ButtonDropdown isOpen={drp_info1} toggle={() => setDrp_info1(!drp_info1)}>
                  ...
                  <div className="btn-group">
                    <ButtonDropdown isOpen={drp_warning1} toggle={() => setDrp_warning1(!drp_warning1)}>
                  ...
                  <div className="btn-group">
                    <ButtonDropdown isOpen={drp_danger1} toggle={() => setDrp_danger1(!drp_danger1)}>
              ...
              <CardBody>
                ...
                <div className="">
                  <div className="btn-group me-1 mt-2">
                    <ButtonDropdown isOpen={drp_secondary} toggle={() => setDrp_secondary(!drp_secondary)}>
                      <DropdownToggle caret color="secondary" className="btn btn-secondary btn-lg">
                  ...
                  <div className="btn-group me-1 mt-2">
                    <ButtonDropdown isOpen={drp_secondary_lg} toggle={() => setDrp_secondary_lg(!drp_secondary_lg)}>
                  ...
                  <div className="btn-group me-1 mt-2">
                    <ButtonDropdown isOpen={drp_secondary_sm} toggle={() => setDrp_secondary_sm(!drp_secondary_sm)}>
                      <DropdownToggle caret color="secondary" className="btn btn-secondary btn-sm">
                  ...
                  <div className="btn-group me-1 mt-2">
                    <ButtonDropdown isOpen={drp_secondary_sm1} toggle={() => setDrp_secondary_sm1(!drp_secondary_sm1)}>
          ...
          <Col xl={6}>
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Trigger dropdown menus above elements by adding <code className="highlighter-rouge">.dropup</code> to
                  the parent element.
                </p>
                <div className="d-flex gap-2 flex-wrap">
                  <Dropdown
                  ...
                  <ButtonDropdown direction="up" isOpen={drp_up11} toggle={() => setDrp_up11(!drp_up11)}>
                    <Button id="caret" color="secondary">
                      Split dropup
                    </Button>
          ...
          <Col lg={6}>
            <Card>
              <CardBody>
                ...
                <div className="d-flex gap-2 flex-wrap">
                  <Dropdown isOpen={info_dropup111} direction="left" toggle={() => setInfo_dropup111(!info_dropup111)}>
          ...
          <Col lg={6}>
            <Card>
              <CardBody>
                ...
                <div className="d-flex gap-2 flex-wrap">
                  <Dropdown isOpen={info_dropup1} direction="right" toggle={() => setInfo_dropup1(!info_dropup1)}>
                  ...
                  <ButtonDropdown direction="right" isOpen={infodrp_up11} toggle={() => setInfodrp_up11(!infodrp_up11)}>
                    <Button id="caret" color="info">
                      Split dropright
                    </Button>
                    <DropdownToggle caret color="info">
          ...
          <Col lg={6}>
            <Card>
              <CardBody>
                ...
                <ButtonDropdown isOpen={drop_align} direction="right" toggle={() => setDrop_align(!drop_align)}>
                  <DropdownToggle caret color="secondary" className="btn btn-secondary">
                    Menu is right-aligned <i className="mdi mdi-chevron-down" />
                  </DropdownToggle>
            ...
            <div className="card">
              <div className="card-body">
                ...
                <p className="card-title-desc">
                  ...
                  <code>data-bs-display="static"</code> attribute and use the responsive variation classes.
                </p>

                <div className="d-flex gap-2 flex-wrap">
                  <div className="btn-group">
                    <ButtonDropdown isOpen={right_align} direction="right" toggle={() => setright_align(!right_align)}>
                      <DropdownToggle caret color="secondary" className="btn btn-secondary">
                  ...
                  <div className="btn-group">
                    <ButtonDropdown isOpen={left_align} direction="left" toggle={() => setleft_align(!left_align)}>
                      <DropdownToggle caret color="secondary" className="btn btn-secondary">
