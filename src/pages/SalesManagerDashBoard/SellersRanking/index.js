...
import SellersRankingTable from './Table';

function SellersRanking({ data, padding = true }) {
  ...
  return (
    ...
    >
      ...
      <Box>
        <SellersRankingTable queryParams={queryParams} setQueryParams={setQueryParams} data={data} />
      </Box>
    </Box>
  );
}
