                      ...
                      <Col xs={8}>
                        <div className="float-end">
                          <ul className="nav nav-pills">
                            ...
                            <NavItem>
                              <Link to="blog-grid " className="nav-link active">
                        ...
                        <Card className="p-1 border shadow-none">
                          ...
                          <div className="p-3">
                            <ul className="list-inline">
                              <li className="list-inline-item me-3">
                                <Link to="#" className="text-muted">
                                  <i className="bx bx-purchase-tag-alt align-middle text-muted me-1"></i> Travel
                                </Link>
                              </li>
                              <li className="list-inline-item me-3">
                                <Link to="#" className="text-muted">
                  ...
                  <div className="mt-5">
                    ...
                    <div className="list-group list-group-flush">
                      <Link to="blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium ms-1"></i> Beautiful Day with Friends
                      </Link>

                      <Link to="blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium ms-1"></i> Drawing a sketch
                      </Link>

                      <Link to="blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium ms-1"></i> Project discussion with team
                      </Link>
                    </div>
                  </div>
                  <div className="mt-5">
                    ...
                    <div className="list-group list-group-flush">
                      <Link to="blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium ms-1"></i> Coffee with Friends
                      </Link>

                      <Link to="blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium ms-1"></i> Neque porro quisquam est
                      </Link>

                      <Link to="blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium ms-1"></i> Quis autem vel eum iure
                      </Link>

                      <Link to="blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium ms-1"></i> Cras mi eu turpis
                      </Link>
