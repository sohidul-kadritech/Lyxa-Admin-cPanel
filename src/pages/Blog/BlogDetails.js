                  ...
                  <div className="row justify-content-center">
                    <div className="col-xl-8">
                      <div>
                        ...
                        <div className="my-5">
                          <img src={img1} alt="" className="img-thumbnail mx-auto d-block" />
                        </div>
                        ...
                        <div className="mt-4">
                          <div className="text-muted font-size-14">
                            <p>
                              ...
                              velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam enim ad
                              minima veniam quis
                            </p>

                            <p className="mb-4">
                              Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam,
                              nisi ut aliquid ex ea reprehenderit qui in ea voluptate velit esse quam nihil molestiae
                              ...
                              <div className="d-flex">
                                ...
                                <div>
                                  <p className="mb-0">
                                    ...
                                    praesentium deleniti atque corrupti quos dolores et quas molestias excepturi sint
                            ...
                            <p>
                              ...
                              alias consequatur aut perferendis doloribus asperiores repellat. Sed ut perspiciatis unde
                          ...
                          <div className="mt-5">
                            <h5 className="font-size-15">
                              <i className="bx bx-message-dots text-muted align-middle me-1"></i> Comments :
                            </h5>
                            ...
                            <div>
                              ...
                              <div className="media py-3 border-top">
                                <div className="avatar-xs me-3">
                                  <img src={avtar1} alt="" className="img-fluid d-block rounded-circle" />
                                </div>
                                <div className="media-body">
                                  <h5 className="font-size-14 mb-1">
