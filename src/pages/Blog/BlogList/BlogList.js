                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <ul className="list-inline">
                        <li className="list-inline-item mr-3">
                          <Link to="#" className="text-muted">
                            <i className="bx bx-purchase-tag-alt align-middle text-muted ms-1"></i> Development
                          </Link>
                        </li>
                        <li className="list-inline-item mr-3">
                          <Link to="#" className="text-muted">
                            <i className="bx bx-comment-dots align-middle text-muted ms-1"></i> 08 Comments
                          </Link>
                        </li>
                      </ul>
                      <p>
                        At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum
                        deleniti atque corrupti quos dolores similique sunt in culpa qui officia deserunt mollitia animi
                        est
                      </p>
                      <div>
                        <Link to="#" className="text-primary">
                  ...
                  <div className="mt-5">
                    ...
                    <div className="list-group list-group-flush">
                      <Link to="/blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium me-1"></i> Beautiful Day with Friends
                      </Link>

                      <Link to="/blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium me-1"></i> Drawing a sketch
                      </Link>

                      <Link to="/blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium me-1"></i> Project discussion with team
                      </Link>
                    </div>
                  </div>
                  <div className="mt-5">
                    ...
                    <div className="list-group list-group-flush">
                      <Link to="/blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium me-1"></i> Coffee with Friends
                      </Link>

                      <Link to="/blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium me-1"></i> Neque porro quisquam est
                      </Link>

                      <Link to="/blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium me-1"></i> Quis autem vel eum iure
                      </Link>

                      <Link to="/blog-details" className="list-group-item text-muted">
                        <i className="mdi mdi-circle-medium me-1"></i> Cras mi eu turpis
                      </Link>
