                ...
                <Row className="justify-content-center mb-5">
                  <Col lg={5}>
                    <div className="text-center faq-title pt-4 pb-4">
                      ...
                      <button type="button" className="btn btn-primary mt-2 mr-1 waves-effect waves-light">
                        Email Us
                      </button>{' '}
                ...
                <Row className="justify-content-center">
                  <Col lg={5}>
                    <h5 className="mt-0 font-size-18 mb-4">
                      <i className="ti-agenda text-primary me-2"></i> General Questions
                    </h5>
                  ...
                  <div className="col-lg-5 offset-lg-1">
                    <h5 className="mt-0 font-size-18 mb-4">
                      <i className="ti-bookmark-alt text-primary me-2"></i> Pricing & Plans
                    </h5>
                      ...
                      <div className="accordion-item">
                        ...
                        <Collapse isOpen={faq8} className="accordion-collapse">
                          <div className="accordion-body">
                            <p className="text-muted mb-0">
                              Everyone realizes why a new common language would be desirable one could refuse to pay
                              expensive translators. Toachieve this, it would be necessary to have uniform grammar.
                            </p>
                          </div>
                        </Collapse>
                      </div>
