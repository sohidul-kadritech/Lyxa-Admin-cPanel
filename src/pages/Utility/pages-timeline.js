                  ...
                  <ul className="timeline list-unstyled">
                    <li className="timeline-list">
                      <div className="cd-timeline-content p-4">
                        ...
                        <p className="mb-0">
                          ...
                          beatae vitae dicta sunt explicabo. enim ipsam voluptatem quia voluptas sit aspernatur aut odit
                          aut fugit
                        </p>
                    ...
                    <li className="timeline-list right clearfix">
                      <div className="cd-timeline-content p-4">
                        ...
                        <button type="button" className="btn btn-primary btn-rounded waves-effect waves-light m-t-5">
                          See more detail
                        </button>
                    ...
                    <li className="timeline-list">
                      <div className="cd-timeline-content p-4">
                        ...
                        <img src={img1} alt="" className="rounded mr-1" width="120" />
