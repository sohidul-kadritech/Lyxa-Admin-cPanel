            ...
            <div className="col-10 text-center">
              <div className="home-wrapper mt-5">
                ...
                <div className="maintenance-img">
                  <img src={maintenanceImg} alt="" className="img-fluid mx-auto d-block" />
                </div>
                  ...
                  <Col md="4" className="text-center">
                    <Card className="mt-4 maintenance-box">
                      <CardBody>
                        ...
                        <h6 className="text-uppercase mt-3">What is the Downtime?</h6>
                        <p className="text-muted mt-3">
                  ...
                  <Col md="4" className="text-center">
                    <Card className="mt-4 maintenance-box">
                      <CardBody>
                        ...
                        <h6 className="text-uppercase mt-3">Do you need Support?</h6>
                        <p className="text-muted mt-3">
                          If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything
                          embar..{' '}
                          <Link to="mailto:no-reply@domain.com" className="text-decoration-underline">
                            no-reply@domain.com
                          </Link>
                        </p>
                      </CardBody>
