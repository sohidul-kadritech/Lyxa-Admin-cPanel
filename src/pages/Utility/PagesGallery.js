...
function PagesGallery() {
  const { galleryList, selectedImages, loading, paging, totalImage, limit, currentPage, haspreviousPage, hasNextPage } =
            ...
            {selectedImages.map((item, index) => (
              ...
              >
                <img
                  ...
                  src={item.path}
                  style={{ width: '100px', height: '70px', objectFit: 'cover', border: '2px solid #dee2e6' }}
                />
