          ...
          <Row className="justify-content-center">
            <Col md="8" lg="6" xl="4">
              <Card className="overflow-hidden">
                <div className="bg-primary">
                  <div className="text-primary text-center p-4">
                    ...
                    <p className="text-white-50">Hello Smith, enter your password to unlock the screen!</p>
                    ...
                    <AvForm className="mt-4">
                      ...
                      <div className="row mb-0">
                        <Col xs="12" className="text-end">
                          <Link className="btn btn-primary w-md waves-effect waves-light" to="/">
                            Unlock
                          </Link>
                        </Col>
                      </div>
              ...
              <div className="mt-5 text-center">
                ...
                <p>
                  © 2021 Veltrix. Crafted with <i className="mdi mdi-heart text-danger" /> by Themesbrand
                </p>
              </div>
            </Col>
          </Row>
