...
function EmailVerification2() {
  return (
    <div>
      <MetaTags>
        <title>Email Verification 2 | Veltrix - Responsive Bootstrap 5 Admin Dashboard</title>
      </MetaTags>
                    ...
                    <div className="text-center">
                      ...
                      <div className="p-2 mt-4">
                        ...
                        <p>
                          ...
                          <span className="font-weight-semibold">example@abc.com</span>, Please check it
                        </p>
                        <div className="mt-4">
