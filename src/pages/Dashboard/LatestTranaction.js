                ...
                <tr key={Math.random()}>
                  <td>
                    <div className="form-check font-size-16">
                      ...
                      <label className="form-check-label" htmlFor={transaction.id}>
                        &nbsp;
                      </label>
                    </div>
                  </td>
                  ...
                  <td>
                    <Badge
                      className={`font-size-11 badge-soft-${transaction.badgeClass}`}
                  ...
                  <td>
                    <i className={`fab ${transaction.methodIcon} me-1`}></i> {transaction.paymentMethod}
                  </td>
                  <td>
