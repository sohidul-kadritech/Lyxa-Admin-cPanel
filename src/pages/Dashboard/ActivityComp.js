          ...
          <ul className="verti-timeline list-unstyled">
              ...
              <Media>
                <div className="me-3">
                  <h5 className="font-size-14">
                    22 Nov <i className="bx bx-right-arrow-alt font-size-16 text-primary align-middle ms-2" />
                  </h5>
                </div>
                <Media body>
            ...
            <li className="event-list">
              ...
              <Media>
                <div className="me-3">
                  <h5 className="font-size-14">
                    17 Nov <i className="bx bx-right-arrow-alt font-size-16 text-primary align-middle ms-2" />
                  </h5>
                </div>
                <Media body>
                  <div id="activitytext">
            ...
            <li className="event-list active">
              ...
              <Media>
                <div className="me-3">
                  <h5 className="font-size-14">
                    15 Nov <i className="bx bx-right-arrow-alt font-size-16 text-primary align-middle ms-2" />
                  </h5>
                </div>
                <Media body>
            ...
            <li className="event-list">
              ...
              <Media>
                <div className="me-3">
                  <h5 className="font-size-14">
                    12 Nov <i className="bx bx-right-arrow-alt font-size-16 text-primary align-middle ms-2" />
                  </h5>
                </div>
                <Media body>
