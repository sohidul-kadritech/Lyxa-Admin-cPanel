              ...
              <Card>
                ...
                <ul className="message-list">
                  ...
                  <li>
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        <span className="bg-warning badge me-2">Freelance</span>
                  ...
                  <li>
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        ...
                        Off on Thursday -{' '}
                        <span className="teaser">
                          Eff that place, you might as well stay here with us instead! Sent from my iPhone 4 4 mar 2014
                          at 5:55 pm
                        </span>
                      </Link>
                  ...
                  <li>
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        ...
                        <span className="teaser">
                          To create this month's pack, we hosted a party with local musician Jared Mahone here in
                          Columbus, Ohio.
                        </span>
                      </Link>
                      <div className="date">Feb 28</div>
                  ...
                  <li className="unread">
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        ...
                        <span className="teaser">
                          Yeah i'd like that! Do you remember the video you showed me of your train ride between Colombo
                          and Kandy? The one with the mountain view? I would love to see that one again!
                        </span>
                      </Link>
                  ...
                  <li>
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        ...
                        <span className="teaser">
                          You've been confirmed! Welcome to the ruling className of the inbox. For your records, here is
                  ...
                  <li>
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        ...
                        <span className="teaser">
                          Hej Nicklas Sandell! Vi vill bjuda in dig till "First tour 2014", ett rekryteringsevent som
                  ...
                  <li>
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        ...
                        Weekend on Revibe –{' '}
                        <span className="teaser">
                          Today's Friday and we thought maybe you want some music inspiration for the weekend. Here are
                          some trending tracks and playlists we think you should give a listen!
                        </span>
                      </Link>
                  ...
                  <li className="unread">
                    ...
                    <div className="col-mail col-mail-2">
                      <Link to="#" className="subject">
                        <span className="bg-info badge me-2">Support</span>
                        Home again! – <span className="teaser">That's just perfect! See you tomorrow.</span>
                      </Link>
