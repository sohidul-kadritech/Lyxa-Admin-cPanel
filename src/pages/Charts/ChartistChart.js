      ...
      <Container fluid>
        ...
        <Row>
          <Col lg={6}>
            <Card>
              <CardBody>
                <CardTitle className="h4 mb-4">Overlapping bars on mobile</CardTitle>
        ...
        <Row>
          <Col lg={6}>
            <Card>
              <CardBody>
                <CardTitle className="h4 mb-4">Animating a Donut with Svg.animate</CardTitle>
                <Row className="justify-content-center">
                  <Col sm={4}>
                    <div className="text-center">
        ...
        <Row>
          <Col lg={6}>
            <Card>
              <CardBody>
                <CardTitle className="h4 mb-4">Advanced Smil Animations</CardTitle>
                <Row className="justify-content-center">
                  <Col sm={4}>
                    <div className="text-center">
