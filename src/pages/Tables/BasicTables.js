            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  For basic styling—light padding and only horizontal dividers—add the base className{' '}
          ...
          <Col xl={6}>
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Use one of two modifier className to make <code>&lt;thead&gt;</code>s appear light or dark gray.
                </p>
          ...
          <Col lg={6}>
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">Use contextual className to color table rows or individual cells.</p>
