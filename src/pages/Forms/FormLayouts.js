...
import { Button, Card, CardBody, CardTitle, Col, Container, Form, Input, InputGroup, Label, Row } from 'reactstrap';
                  ...
                  <Row>
                    <Col lg={4}>
                      <div className="mb-3">
                        ...
                        <Input type="text" className="form-control" id="formrow-InputCity" />
                      </div>
                    </Col>
                    <Col lg={4}>
                      <div className="mb-3">
                        <Label htmlFor="formrow-InputState">State</Label>
                        <select id="formrow-InputState" className="form-control">
                    ...
                    <Col lg={4}>
                      <div className="mb-3">
                        ...
                        <Input type="text" className="form-control" id="formrow-InputZip" />
                      </div>
                    </Col>
                  </Row>
