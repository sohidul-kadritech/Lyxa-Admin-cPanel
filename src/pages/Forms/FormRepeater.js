                  ...
                  <div data-repeater-list="outer-group" className="outer">
                    <div data-repeater-item className="outer">
                      <div className="mb-3">
                        ...
                        <Input type="text" id="formname" placeholder="Enter your Name..." className="form-control" />
                      </div>
                      ...
                      <div className="mb-3">
                        ...
                        <Input type="email" id="formemail" placeholder="Enter your Email..." className="form-control" />
                      </div>
                      ...
                      <div className="inner-repeater mb-4">
                        ...
                        <table style={{ width: '100%' }}>
                          <tbody>
                            ...
                            {rows1.map((item1, idx) => (
                              <tr id={`nested${idx}`} key={Math.random()}>
                                <td>
                                  <Row className="mb-2">
                                    <Col md="10">
                                      <Input
                                        type="text"
                                        className="inner form-control"
                                        placeholder={`Enter your phone no... ${idx + 2}`}
                                      />
                                    </Col>
                                    <Col md="2">
                                      <Button color="primary" className="btn-block inner" style={{ width: '100%' }}>
                                        {' '}
                                        Delete{' '}
                                      </Button>
                                    </Col>
