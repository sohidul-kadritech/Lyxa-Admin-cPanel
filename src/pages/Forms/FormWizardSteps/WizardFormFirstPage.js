        ...
        <Row>
          <Col md={6}>
            <Row className="form-group">
              ...
              <Col lg={9}>
                <textarea id="txtAddress1Billing" name="txtAddress1Billing" rows="4" className="form-control" />
              </Col>
            </Row>
          </Col>
          <Col md={6}>
            <Row className="form-group">
              ...
              <Col lg={9}>
                <textarea id="txtAddress2Billing" name="txtAddress2Billing" rows="4" className="form-control" />
              </Col>
            </Row>
          </Col>
        </Row>
