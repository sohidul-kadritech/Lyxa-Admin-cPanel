                    ...
                    <Col md="4">
                      <div className="mb-3 position-relative">
                        ...
                        <div
                          ...
                          id="validate2"
                        >
                          {lnm === true ? 'Looks good!' : 'Please Enter Valid Last Name'}
                        </div>
                      </div>
                    </Col>
                    <Col md="4">
                      <div className="mb-3 position-relative">
                        ...
                        <div className="input-group">
                          ...
                          <div
                            ...
                            id="validate3"
                          >
                            {unm === true ? 'Looks good!' : 'Please choose a unique and valid username.'}
                          </div>
                        </div>
                      </div>
                    </Col>
                    ...
                    <Col md="6">
                      <div className="mb-3 position-relative">
                        ...
                        <div
                          ...
                          id="validate5"
                        >
                          {stateV === true ? 'Looks good!' : 'Please provide a valid state.'}
                        </div>
                      </div>
                    </Col>
                  </Row>
            ...
            <Card>
              <CardBody>
                ...
                <CardSubtitle className="mb-3">
                  Parsley is a availity reactstrap validation. It helps you provide your users with feedback on their
