...
import { Card, CardBody, CardSubtitle, CardTitle, Col, Container, Row, Table } from 'reactstrap';
            ...
            <Card>
              <CardBody>
                ...
                <CardSubtitle className="mb-3">
                  This library allows you to create editable elements on your page. It can be used with any engine
                  (bootstrap, jquery-ui, jquery only) and includes both popup and inline modes. Please try out demo to
                  see how it works.
                </CardSubtitle>
