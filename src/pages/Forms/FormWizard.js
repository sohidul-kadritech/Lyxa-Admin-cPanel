...
import { Card, CardBody, Col, Container, Form, Input, NavItem, NavLink, Row, TabContent, TabPane } from 'reactstrap';
                      ...
                      <TabPane tabId={2}>
                        <Form>
                          <Row>
                            <Col md={6}>
                              <Row className="mb-3">
                                <label htmlFor="txtFirstNameShipping" className="col-lg-3 col-form-label">
                                  PAN Card
                                </label>
                                <div className="col-lg-9">
                                  <Input
                            ...
                            <Col md={6}>
                              <Row className="mb-3">
                                <label htmlFor="txtLastNameShipping" className="col-lg-3 col-form-label">
                                  VAT/TIN No.
                                </label>
                                <div className="col-lg-9">
                                  <Input
                          ...
                          <Row>
                            <Col md={6}>
                              <Row className="mb-3">
                                <label htmlFor="txtCompanyShipping" className="col-lg-3 col-form-label">
                                  CST No.
                                </label>
                                <div className="col-lg-9">
                                  <Input
                            ...
                            <Col md={6}>
                              <Row className="mb-3">
                                <label htmlFor="txtEmailAddressShipping" className="col-lg-3 col-form-label">
                                  Service Tax No.
                                </label>
                                <div className="col-lg-9">
                                  <Input
                          ...
                          <Row>
                            <Col md={6}>
                              <Row className="mb-3">
                                <label htmlFor="txtCityShipping" className="col-lg-3 col-form-label">
                                  Company UIN
                                </label>
                                <div className="col-lg-9">
                                  <Input
                            ...
                            <Col md={6}>
                              <Row className="mb-3">
                                <label htmlFor="txtStateProvinceShipping" className="col-lg-3 col-form-label">
                                  Declaration
                                </label>
                                <div className="col-lg-9">
                                  <Input
