                ...
                <div className="d-flex justify-content-end align-items-center">
                    <div className="d-flex">
                        ...
                        >
                            ...
                            {props.loading ? <Spinner animation="border" variant="info" style={{ width: '20px', height: "20px" }} /> : <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" width="20px" fill="none" viewBox="0 0 24 24" stroke="currentColor">
